  ...
  ({ className, hover = false, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        hover && "hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1 cursor-pointer hover:border-primary/20",
        className
      )}
      {...props}
    />
...
const CardTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-lg md:text-xl font-semibold leading-none tracking-tight", className)} {...props} />
  )
);
